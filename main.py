...
def attack(char_name: str, char_class: str) -> str:
    """Возвращает атаку мага вритель и лекаря в игре."""
    ...
    if char_class == 'healer':
        ...
        return f'{char_name} нанёс урон противнику равный {damage}'
    return ''  # Явное возвращение значения


def defence(char_name: str, char_class: str) -> str:
    """Возвращает блокировку урона для каждого персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает специальные умения героем: атака, выносливочть, защита."""
    if char_class == 'warrior':
        power = 80 + 25
...
def start_training(char_name: str, char_class: str) -> str:
    """
        Принимает на вход вашего версонажа и тренирует его атаку.
        защиту и выносливость.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор персонажа в начале для дальнейшей игры."""
    approve_choice: str = ''
    char_class: str = ''
